...
(deftest lookup-api-test
  (testing "Test lookup api and response."
    ...
    (let [request (mock/request :get "/lookup" {:address "9700 Sw 67th ave" :city "Miami" :state "Florida" :zip "33156"})
          ...
          expected "[{\"rectype\":\"representative\",\"prefix\":\"The Honorable\",\"firstname\":\"Ileana\",\"middlename\":\"\",\"lastname\":\"Ros-Lehtinen\",\"suffix\":\"\",\"address\":\"2206 Rayburn House Office Building\",\"city\":\"Washington\",\"state\":\"DC\",\"zip\":\"20515-0927\",\"region\":\"FL27\",\"bioguide-id\":\"R000435\",\"party\":\"R\",\"image-url\":\"ziplook.house.gov/zip/pictures/fl27_ros-lehtinen.jpg\",\"home-page\":\"http://ros-lehtinen.house.gov/\"}]"]
