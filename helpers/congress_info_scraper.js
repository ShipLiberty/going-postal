...
const houseURL = 'https://vote-usa.org/officials.aspx?report=u3';
...
(async () => {
	...
	let arrayOfReps = await page.evaluate(() => {  								
		...
		repElements.forEach((repElement) => { 											
			...
			try {
				//office
				repData.office = 'congressperson';
				//get district
                repData.district = repElement.querySelector('div.cell-heading').innerText;
